...
import { NotificationBell } from './features/communityFeatures'
...
const iconFor = (name) => name.includes('Dashboard') || name === 'Overview' ? LayoutDashboard : name.includes('course') || name === 'Courses' ? BookOpen : name === 'Users' || name === 'Students' ? Users : name === 'Calendar' ? CalendarDays : name === 'Messages' || name === 'Discussions' ? MessageSquare : name === 'Announcements' ? Bell : name === 'Assignments' ? ClipboardList : name === 'Notifications' ? NotificationInbox : name === 'Progress' ? Progress : name === 'Attendance' ? UserCheck : name === 'Achievements' ? Trophy : name === 'Search' ? Search : name === 'Materials' ? FolderOpen : name === 'Reviews' ? Star : FileText
