...
export const contentApi = {
  ...
  mySubmissions: () => api.get('/submissions/my'), feedback: (id, data) => api.post(`/submissions/${id}/feedback`, data),
  ...
  announcements: (params) => api.get('/announcements', { params }), addAnnouncement: (data) => api.post('/announcements', data), removeAnnouncement: (id) => api.delete(`/announcements/${id}`),
...
export const engagementApi = {
  ...
  calendar: (params) => api.get('/calendar', { params }), addCalendarEvent: (data) => api.post('/calendar', data), checkout: (data) => api.post('/payments/checkout', data), payments: () => api.get('/payments/my'),
}
